...
<html lang="en">
  <head>
    ...
    <title>Train Up - Trainee Dashboard</title>
                        ...
                        <ul class="navbar-nav ml-auto">
                          <li class="nav-item dropdown no-arrow mx-1">
                            <a
                              ...
                              aria-expanded="false"
                            >
                              <i class="fas fa-clipboard-list fa-fw fa-2x"></i>
                            </a>
                          </li>
                        </ul>
                      </div>
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <!-- <div class="card border-left-info shadow h-100 py-2">
                              <div class="card-body">
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                          <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Present Trainee
                                          </div>
                                          <div class="row no-gutters align-items-center">
                                              <div class="col-auto">
